...
password = input("Choose strong password to encrypt your files: ") # The Password for all the pdf
path = input("Select the Folder where the PDF FILES are: ") # The Folder where the PDF FILES are
                                                            # e.g C:/Users/NACWC 7/Desktop/PYTHON/pass_pdf
